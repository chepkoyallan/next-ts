Google Service Management manages a set of _services_. Service
Management allows _service producers_ to
publish their services on Google Cloud Platform so that they can be discovered
and used by _service consumers_. It also handles the tasks of tracking
